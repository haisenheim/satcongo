            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td colspan="4">
                            <h4 style="font-size: 20px; text-align: center;">Journal des operations</h4>
                            <h5 style="font-size: 16px; text-align: center;">CAISSE : {{ $caisse->name }} / {{ $caisse->agence->name }} {{ $caisse->ville->name }}</h5>
